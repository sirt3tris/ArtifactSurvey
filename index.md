...
It is worth mentioning that for both groups, Artifact learnability is relatively low. This suggest that the game rules are perceived as complex and that are not easy to grasp from the tutorial. Also worth noting that the social aspects of the game fill the bottom three chart for both groups. This means that the game is not considered to be interactive or that interaction doesn't feel quite right during the game. Quite interesting for a card game that tries to deliver a "kitchen table" experience.
