...
Despite the relatively low sample size, I think this data offer the possibility to draw some interesting conclusions regarding what is currently wrong with Artifact: 

- **Casual players.** Some people are playing the game casually, and the game is not fun for them. It is tricky to actually determine from the current data whether they don't play often because they don't like the game or the other way around. However, for a considerable amount of Artifact players (roughly 20% of the survey sample), the prevalent feelings are tension, frustration and bad mood. They are not engaged in the game, have no clue on how to improve and struggle to learn the game basics. 
- **Learning the basics.** New players are struggling to learn the basics and in reaching out the gaming community as well. In fact, from the global rating on the social aspects of the game, Learnability and social aspects are among the worst of the Artifact experience. Even if the game is designed to be "hardcore", new players always face an entry phase in which the game need to be learned, the skill still need to be shaped and the community need to be reached. It's going to be quite hard for this people to fully enjoy the game best aspects from the beginning.
- **Game modalities.** Some of the game modalities are played by a ridiculusly low amount of players. Even if the sample of the current survey is relatively small, almost noone seems to play Keeper draft and even the constructed format (arguably one of the game main formats) seems to be relatively under-represented in the current sample of players. 
- **Game balance and RNG.** Many players, especially the frequent ones, are concerned with the game balance. They seem to be particularly unhappy with some cards perceived as too powerful. Moreover around 60% of the infrequent players and 37% of the frequent players agree on the fact that the game has too much RNG. I have the feeling that the RNG aspects of the game are not well understood by everybody. While everyone probably faced some tilting situation while playing Artifact, I think that many would agree that the it is also a crucial aspect of the entire game mechanics, and (maybe?) also what makes the game so challenging. Sometimes getting lucky is a matter of skill. 
- **Rewards and Progression.** Needless to spend more words about these two features of Artifact. I know, you know, Valve knows, everybody knows. Some important changes in this direction need to be made in order to make the game more engaging, to attract new players and incentivize the development of the current playerbase.

### Future directions

During the development of this project I had a bunch of new ideas on how to collect new data and make better use of the current ones. First of all there might be more information in the current dataset. If some of you is interested in accessing the data I will share them on this page. The only reason why I didn't do that yet is because it will obviously require some effort and I am not sure if anybody would actually be interested (I might end up doing it anyways in the next couple of weeks). Second, I'm willing to develop a new survey in the near future: with less items and hopefully more participants. In this way it might be possible to test some real hypotheses and more interesting analyses.
If you have any question feel free to contact me at ages914@gmail.com
